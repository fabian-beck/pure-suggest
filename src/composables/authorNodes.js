 ...
 */
export function initializeAuthorNodes(nodeSelection, authorNodeMouseover, authorNodeMouseout, authorNodeClick) {
...
export function updateAuthorNodes(nodeSelection, sessionStore, existingTooltips) {
    ...
    authorNodes.attr("data-tippy-content", (d) => {
        const yearDisplay = d.author.yearMin === d.author.yearMax 
