<template>
  <ModalDialog v-model="interfaceStore.isKeyboardControlsModalDialogShown" title="Keyboard Controls"
    icon="mdi-keyboard-outline" headerColor="light">
    <div class="content">
      <section>
        <p>
          You can use the following keyboard shortcuts to control the
          application.
        </p>
        <h2>General</h2>
        <ul class="keys">
