...
describe('Session Store - Suggested Publications Filtering', () => {
  ...
  describe('integration with Filter class', () => {
    ...
    it('should maintain original behavior when no active filters', () => {
      interfaceStore.isFilterPanelShown = true
      // Filter panel shown but no active filters
  ...
  describe('consistency with selected publications behavior', () => {
    it('should behave consistently with selected publications filtering', () => {
      ...
      expect(sessionStore.selectedPublicationsFilteredCount).toBe(sessionStore.suggestedPublicationsFilteredCount)
      expect(sessionStore.selectedPublicationsNonFilteredCount).toBe(sessionStore.suggestedPublicationsNonFilteredCount)
    })
  })
})